        ...
        <div class="app-container">
            ...
            <div class="card_form">
                ...
                <form action="BookingServlet" method="post" style="font-family: 'Poppins', sans-serif;">
                    ...
                    <button id="button" class="buttonAnimation ready" onclick="clickButton();">
            ...
            <canvas id="canvas"></canvas>      
                ...
                %>
            <div style="height: 600px; margin-bottom: 50px;  background: rgba(255, 255, 255, 0.875); margin-top: 200px" class="overlay">
                <!-- Overlay inner wrapper -->
