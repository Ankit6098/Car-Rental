                ...
                <div class="app-header-right">
                    ...
                    <div class="dropdown">
                        <ul class="dropdown-content">
                            <li onClick="functionProfile()" style="background-color: #185ee0; color: white" class="dropdown-item"><i class="fas fa-user-circle"></i> Profile</li>
                            <li class="divider"></li>
                            ...
                            <li onClick="functinoSettings()" class="dropdown-item"><i class="fas fa-cog"></i> Settings</li>
                            <li class="divider"></li>
            ...
            <div class="overlay">
                ...
                <div class="overlay__inner">
                    ...
                    <div class="card">
                        ...
                        <div style="margin-left: 498px; margin-top: -140px; font-size: 0.9rem; color: white; z-index: 1;">
                            <%= user.getEmail()%>
                        </div>
